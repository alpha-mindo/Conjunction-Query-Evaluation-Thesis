...
public class RunTestsFull {
    public static void main(String[] args) throws Exception {
        ...
        tex.append("This chapter presents the full datasets, output results, and statistics for all test cases.\n\n");
        ...
        for (String d : dirs) {
            ...
            for (String caseName : new TreeSet<>(testCases.keySet())) {
                ...
                Map<String, Relation> relations = new HashMap<>(); // keep sorted maybe?
        ...
        System.out.println("Written to General.tex!");
    }
}
